...
#define RELOAD_VALUE                   48828u                  /* Reload value to have an interrupt each 500ms         */
#define RELOAD_VALUE_T2                9767u                  /* Reload value to have an interrupt each 500ms         */
#define RELOAD_VALUE_T3                19563u                  /* Reload value to have an interrupt each 500ms         */
...
void initGpt12Timer(void)
{
    ...
    IfxGpt12_T3_setTimerValue(&MODULE
GPT120, RELOAD_VALUE_T3);                        /* Set T3 start value           */
    ...
    //IfxGpt12_T2_setTimerPrescaler(&MODULE_GPT120, IfxGpt12_TimerInputPrescaler_64); /* Set T3 input prescaler       */
    IfxGpt12_T2_setTimerValue(&MODULE_GPT120, RELOAD_VALUE_T2);                        /* Set T2 reload value          */
    ...
    IfxSrc_enable(srcT2);                                                             /* Enable GPT12 interrupt       */
